...
# 전체 처치 수 구하기
train_df['Kills_and_headshotKills'] = train_df['kills'] + train_df['headshotKills']
train_df = train_df.drop(['kills', 'headshotKills'], axis=1)

# winPlacePerc와 상관관계가 낮은 데이터 지우기
train_df = train_df.drop(['assists', 'DBNOs', 'killPlace', 'killPoints', 'matchDuration', 'revives', 'roadKills',
